  ...
  try {
    ...
    if (questionIndex===4) {
      ...
      interview.questions.forEach((q, index) => {
        q.feedback = feedbackResults.evaluations[index].feedback;
        q.score = feedbackResults.evaluations[index].score;
        totalScore = totalScore+feedbackResults.evaluations[index].score;
      });
