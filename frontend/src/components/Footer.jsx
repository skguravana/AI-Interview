      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold mb-2">Intelli View</h2>
            <p className="text-gray-200">Empowering your interview success with AI</p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200/30 text-center text-sm">
          <p>© 2025 Intelli View. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
